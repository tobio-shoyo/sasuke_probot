...
def warn(
    ...
    if user.id in TIGERS:
        if warner:
            message.reply_text("Generals cant be warned.")
        else:
            message.reply_text(
                "General triggered an auto warn filter!\n I can't warn General but they should avoid abusing this.",
            )
        return

    if user.id in WOLVES:
        if warner:
            message.reply_text("Practitioner disasters are warn immune.")
        else:
            message.reply_text(
                "Practitioners Disaster triggered an auto warn filter!\nI can't warn Practioners but they should avoid abusing this.",
            )
        return
